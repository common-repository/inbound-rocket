...
@Power-up URI: https://inboundrocket.co/features/people-search/
@Power-up Description: See social profiles and company information for every contact.
@Power-up Icon: power-up-icon-people-search
@Power-up Icon Small: 
@Power-up Sort: 1
...
if ( !defined('INBOUNDROCKET_PEOPLESEARCH_PATH') )
    define('INBOUNDROCKET_PEOPLESEARCH_PATH', INBOUNDROCKET_PATH . '/inc/power-ups/people-search');

if ( !defined('INBOUNDROCKET_PEOPLESEARCH_PLUGIN_DIR') )
	define('INBOUNDROCKET_PEOPLESEARCH_PLUGIN_DIR', INBOUNDROCKET_PLUGIN_DIR . '/inc/power-ups/people-search');
