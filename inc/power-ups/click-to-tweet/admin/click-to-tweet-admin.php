...
class WPClickToTweetAdmin extends WPInboundRocketAdmin {
    ...
    {
	    $this->plugin_settings_tabs[$this->power_up_settings_section] = __('Click To Tweet','inbound-rocket');
		...
		add_settings_field('ir_ctt_settings', __('Click To Tweet Settings','inbound-rocket'), array($this, 'ir_ctt_input_fields'), $this->power_up_settings_section, 'ir_ctt_section');
    }
	...
	public function ir_ctt_input_fields ()
	{
		...
		?>
		<tr valign="top">
			<th style="width: 200px;"><label><?php _e('Instructions','inbound-rocket');?></label></th>
			<td><?php _e('To use, simply include the Click to Tweet code in your post. Place your message within the parentheses. Tweet length will be automatically truncated to 260 characters (to give space for your Twitter username as well).','inbound-rocket');?>  <pre>[clicktotweet]<?php _e('This is a tweet. It is only a tweet.','inbound-rocket');?>[/clicktotweet]</pre></td>
		</tr>
		<tr valign="top">
			<th style="width: 200px;"><label><?php _e('Your Twitter Handle','inbound-rocket');?></label></th>
			<td><input type="text" name="inboundrocket_ctt_options[ir_ctt_twitter_username]" id="ir_ctt_twitter_username" value="<?=$ir_ctt_twitter_username;?>" />
				<br /><span class="description"><?php _e('Enter your Twitter handle to add "via @yourhandle" to your tweets. Do not include the @ symbol.','inbound-rocket');?></span></td>
		</tr>
	<?php					
	}
